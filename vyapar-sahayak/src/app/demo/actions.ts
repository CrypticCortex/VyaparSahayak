...
export async function seedAndDetect() {
  ...
  // -- Demo campaigns for top alerts --
  const campaignProducts = [
    { alertIdx: 0, headline: "Special Sale!", message: "Kalyan Traders special offer! 20% OFF - Limited stock! Order now! 98765 43210" },
    { alertIdx: 2, headline: "Clearance Deal!", message: "Kalyan Traders special clearance! 25% OFF on selected items! Stock limited!" },
    { alertIdx: 4, headline: "Mega Sale!", message: "Mega sale at Kalyan Traders! 15% OFF - order today! 98765 43210" },
  ];
  ...
  return { success: true, alerts: atRisk.length, campaigns: campaignProducts.length };
}
