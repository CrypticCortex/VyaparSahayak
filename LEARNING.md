...
- **Database**: Turso cloud SQLite at `libsql://vyapar-sahayak-crypticcortex.aws-ap-south-1.turso.io`
...
|----------|-------|-------|
| DATABASE_URL | `libsql://vyapar-sahayak-crypticcortex.aws-ap-south-1.turso.io` | Turso cloud URL |
